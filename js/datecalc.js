...
const targetDate = new Date('2021-07-01');

const currentDate = new Date();

const dateDifferenceInMillis = currentDate - targetDate;
...
document.getElementById('dateDifference3').textContent = `${years} yr ${months} mo`;